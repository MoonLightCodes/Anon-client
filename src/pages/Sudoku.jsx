...
const SudokuMain = () => {
  ...
  return (
    <div className="max-w-lg mx-auto mt-6 px-2 text-center select-none w-[80vw] ">
      ...
      {(gameStarted || gameWon || gameOver) && (
        <>
          ...
          <div className="mt-3 grid grid-cols-9 border-4 border-gray-900 rounded-md overflow-hidden">
            {board.map((row, r) =>
              row.map((val, c) => (
                <Cell
                  key={`${r}-${c}`}
